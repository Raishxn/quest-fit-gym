...
export function LeaderboardList({ 
  ...
  userId, 
  getValueKey, 
  getSecondaryValueKey,
  showChallengeButton = true
}: { 
  data: any[], 
  startRank?: number, 
  userId?: string, 
  getValueKey: (d:any) => string, 
  getSecondaryValueKey?: (d:any) => string,
            ...
            >
              ...
              <div className="flex-1 min-w-0 z-20">
                <div className="flex items-center gap-2">
                  ...
                  {!isMe && showChallengeButton && (
                    <Button 
                      variant="ghost" 
                      size="icon" 
                      className="h-6 w-6 text-muted-foreground hover:text-primary hover:bg-primary/20 transition-colors"
