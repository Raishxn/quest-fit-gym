import { Home, Dumbbell, ListMusic, Salad, Activity, TrendingUp, Trophy, Users, User, Settings, Swords, Target, Shield, MessageSquare, Infinity as InfinityIcon, ShoppingBag } from 'lucide-react';
